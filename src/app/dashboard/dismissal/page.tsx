...
const mockPendingDismissalRequests: MockPendingDismissalRequest[] = [
  {
    ...
    zanId: '221458232', // Employee is 'On Probation'
                ...
                <div>
                  ...
                  <div className="p-4 rounded-md border bg-secondary/20 space-y-3 shadow-sm">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3 text-sm">
                      ...
                      <div><Label className="text-muted-foreground">Institution:</Label> <p className="font-semibold text-foreground">{employeeDetails.institution || 'N/A'}</p></div>
                      <div className="md:col-span-2"><Label className="text-muted-foreground">Current Status:</Label> <p className={`font-semibold ${isDismissalAllowed ? 'text-green-600' : 'text-red-600'}`}>{employeeDetails.status || 'N/A'}</p></div>
                    </div>
                  </div>
                </div>
