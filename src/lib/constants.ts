...
export const EMPLOYEES: Employee[] = [
  ...
  { 
    ...
    ministry: "Public Service and Good Governance",
    institutionId: findInst('inst_5')?.id,
    institution: findInst('inst_5')?.name,
    appointmentType: "Permanent",
    contractType: "Full-time",
  ...
  { 
    ...
    institutionId: findInst('inst_9')?.id,
    institution: findInst('inst_9')?.name,
    appointmentType: "Permanent",
    contractType: "Full-time",
  ...
  { 
    ...
    institutionId: findInst('inst_6')?.id,
    institution: findInst('inst_6')?.name,
    appointmentType: "Permanent",
    contractType: "Full-time",
  ...
  { 
    ...
    department: "Planning",
    ministry: "Finance and Planning",
    institutionId: findInst('inst_36')?.id,
    institution: findInst('inst_36')?.name,
    appointmentType: "Permanent",
    contractType: "Full-time",
  ...
  { 
    ...
    ministry: "Finance and Planning",
    institutionId: findInst('inst_21')?.id,
    institution: findInst('inst_21')?.name,
    appointmentType: "Permanent",
    contractType: "Full-time",
  ...
  { 
    ...
    institutionId: findInst('inst_19')?.id,
    institution: findInst('inst_19')?.name,
    appointmentType: "Permanent",
    contractType: "Full-time",
  ...
  { 
    ...
    institutionId: findInst('inst_40')?.id,
    institution: findInst('inst_40')?.name,
    appointmentType: "Permanent",
    contractType: "Full-time",
