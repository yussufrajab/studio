...
export const USERS: User[] = [
  ...
  { id: "user_hro_cgo", username: "kmnyonge", name: "Khamis Mnyonge", role: ROLES.HRO as Role, institutionId: 'inst_17', institution: 'OFISI YA RAIS, FEDHA NA MIPANGO' },
  { id: "user_hro_moe", username: "ahmedm", name: "Ahmed Mohammed", role: ROLES.HRO as Role, institutionId: 'inst_40', institution: 'WIZARA YA ELIMU NA MAFUNZO YA AMALI' },
  { id: "user_hro_moh", username: "mariamj", name: "Mariam Juma", role: ROLES.HRO as Role, institutionId: 'inst_41', institution: 'WIZARA YA AFYA' },
...
export const EMPLOYEES: Employee[] = [
  ...
  // START: New employees for OFISI YA RAIS, FEDHA NA MIPANGO (inst_17)
  {
    id: "emp10",
